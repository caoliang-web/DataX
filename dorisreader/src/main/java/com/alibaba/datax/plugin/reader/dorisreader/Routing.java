...
public class Routing {
    ...
    private void parseRouting(String routing) throws IllegalArgumentException {
        logger.info("Parse Doris BE address: '{}'.", routing);
        String[] hostPort = routing.split(":");
        if (hostPort.length != 2) {
            String msg = ("Format of Doris BE address '{}' is illegal." + routing);
        ...
        try {
            ...
            String msg = ("Parse '{}' to number failed. Original string is '{}'.Doris BE's port" + hostPort[1]);
            throw new IllegalArgumentException(msg);
        }
    }
